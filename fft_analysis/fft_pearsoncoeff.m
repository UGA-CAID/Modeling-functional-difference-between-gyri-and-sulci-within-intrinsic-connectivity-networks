...
color_file = '/data/hzb1/matlab_toolbox/color/colorscheme_1.scss';

mycolor = generate_mycolor_from_file(color_file);
...
result_root_path = '/data/hzb1/Projects/S900_RSN/New_Adjusted_GSextract_order/CNN_training/output/Contact_Data_taskshuffled_Group_2_test_consistent/';
...
saveas(gcf, [save_path 'group1_sulci_p_corr.png']);
saveas(gcf, [save_path 'group1_sulci_p_corr.fig']);
clf;
...
saveas(gcf, [save_path 'group1_gyri_p_corr_thre_adjusted.png']);
% saveas(gcf, [save_path 'group1_gyri_p_corr.fig']);
...
saveas(gcf, [save_path 'group2_sulci_p_corr.png']);
saveas(gcf, [save_path 'group2_sulci_p_corr.fig']);
...
saveas(gcf, [save_path 'group2_gyri_p_corr_thre_adjusted.png']);
% saveas(gcf, [save_path 'group2_gyri_p_corr.fig']);
...
saveas(gcf, [save_path 'taskshuffled1_sulci_p_corr.png']);
saveas(gcf, [save_path 'taskshuffled1_sulci_p_corr.fig']);
...
saveas(gcf, [save_path 'taskshuffled1_gyri_p_corr_adjusted.png']);
% saveas(gcf, [save_path 'taskshuffled1_gyri_p_corr.fig']);
...
saveas(gcf, [save_path 'taskshuffled2_sulci_p_corr.png']);
% saveas(gcf, [save_path 'taskshuffled2_sulci_p_corr.fig']);
...
saveas(gcf, [save_path 'taskshuffled2_gyri_p_corr_adjusted.png']);
% saveas(gcf, [save_path 'taskshuffled2_gyri_p_corr.fig']);
...
saveas(gcf, [save_path 'group1_gs_p_corr_thre_adjusted.png']);
% saveas(gcf, [save_path 'group1_gs_p_corr.fig']);
...
saveas(gcf, [save_path 'group2_gs_p_corr_thre_adjusted.png']);
...
saveas(gcf, [save_path 'taskshuffled1_gs_p_corr_adjusted.png']);
...
saveas(gcf, [save_path 'taskshuffled2_gs_p_corr_adjusted.png']);
