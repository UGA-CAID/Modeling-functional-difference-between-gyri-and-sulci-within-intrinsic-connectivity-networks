...
%         subplot(8,8,i); 
    ...
    figname = [num2str(rsnid, '%d'), '.conv_pred.sulci.fft_power_only_curves.png'];
    saveas(gcf,figname);
    figname = [num2str(rsnid, '%d'), '.conv_pred.sulci.fft_power_only_curves.fig'];
    saveas(gcf,figname);
    clf;
...
%         subplot(8,8,i); 
    ...
    figname = [num2str(rsnid, '%d'), '.conv_pred.gyri.fft_power_only_curves.png'];
    saveas(gcf,figname);
    figname = [num2str(rsnid, '%d'), '.conv_pred.gyri.fft_power_only_curves.fig'];
    saveas(gcf,figname);
    clf;
...
%     plot(f, P1_sum/pcount, 'LineWidth', 8 , 'color', [51/256 64/256 158/256]);
    ...
    figname = [num2str(rsnid, '%d'), '.conv_pred.sulci&gyri.fft_power_avg_0excluded_onlycurves.png'];
    saveas(gcf,figname);
    figname = [num2str(rsnid, '%d'), '.conv_pred.sulci&gyri.fft_power_avg_0excluded_onlycurves.fig'];
    saveas(gcf,figname);
    clf;
end
