    ...
    for rsn_i in range(iStart, iEnd + 1):
        ...
        for sub_i in sub_list:
            ...
            with open('/data1/wqy/Projects/S900_RSN/CNN_training/experiments/2corssval_test_on_sub_contacted_2.yaml') as f:
                ...
                content['TEST']['MODEL_DIR'] = 'output/contacted_training_taskshuffled/%02d/' % (rsn_i)
                content['TEST']['RESULT_DIR'] = 'output/contacted_training_taskshuffled/test_results/%02d/%d/' % (rsn_i, sub_i)
                pre_path = '/data1/wqy/Projects/S900_RSN/CNN_training/output/contacted_training_taskshuffled/test_results/%02d/%d/' % (rsn_i, sub_i)
