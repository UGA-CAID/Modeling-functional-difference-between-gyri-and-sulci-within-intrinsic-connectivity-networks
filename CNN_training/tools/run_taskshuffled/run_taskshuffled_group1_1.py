...
import main_taskshuffled_group1_1
import yaml
...
if __name__ == '__main__':
    ...
    with open(experiment_cls_path) as f:
        ...
        content['TRAIN']['OUTPUT_DIR'] = 'output/Contact_Data_taskshuffled_Group_1/%02d' % (rsn_i)
        content['TEST']['RESULT_DIR'] = 'output/Contact_Data_taskshuffled_Group_1/%02d' % (rsn_i)
        content['BASIC']['LOG_DIR'] = 'logs/Contact_Data_taskshuffled_Group_1/%02d'% (rsn_i)
    ...
    main_taskshuffled_group1_1.main()