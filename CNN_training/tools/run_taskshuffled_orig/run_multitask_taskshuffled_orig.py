...
if __name__ == '__main__':
    for rsn_i in range(iStart, iEnd + 1):
        if rsn_i == 5:
            continue
        with open('/data1/wqy/Projects/S900_RSN/CNN_training/experiments/shuffled_orig/cls_shuffled_1.yaml') as f:
            content = yaml.load(f)
        ...
        with open('/data1/wqy/Projects/S900_RSN/CNN_training/experiments/shuffled_orig/cls_shuffled_1.yaml', 'w') as nf:
            yaml.dump(content, nf)
        main_shuffled_1.main()